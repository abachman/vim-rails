  ...
  if (!exists("g:rails_syntax") || g:rails_syntax)
    ...
    if &syntax == 'ruby'
      ...
      if buffer.type_name('test')
        ...
        syn keyword rubyRailsTestMethod pass refute refute_empty refute_equal refute_in_delta refute_in_epsilon refute_includes refute_instance_of refute_kind_of refute_match refute_nil refute_operator refute_respond_to refute_same skip
